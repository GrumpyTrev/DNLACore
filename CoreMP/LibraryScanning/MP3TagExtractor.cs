...
namespace CoreMP
{
	internal static class MP3TagExtractor
	{
		/// <summary>
		...
		private static int BitRate( byte rawVersion, byte rawLayer, byte rawRate ) => rateLookup[ rawVersion, rawLayer, rawRate ] * 1000;
		...
		private static int SampleRate( byte rawVersion, byte rawSampleRate ) => sampleLookup[ rawVersion, rawSampleRate ];
		...
		private static int SamplesPerFrame( byte rawVersion, byte rawLevel ) => samplesPerFrameLookup[ rawVersion, rawLevel ];
